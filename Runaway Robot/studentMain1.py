...
def estimate_next_pos(measurement, OTHER = None):
    ...
    #implement using particle filter
    #measurements store information of absolute value of a point (like landmarks in particle filter)
    #Other store robot new position and new orientation.
    ...
    deltaX_pst=dist*cos(orientation_pst)
    deltaY_pst=dist*sin(orientation_pst)
    X_pst=X_measure+ deltaX_pst
    Y_pst=Y_measure+ deltaY_pst
    
    
    xy_estimate = (X_pst,Y_pst)
    OTHER={'pos':measurement, 'orientation':orientation_measure}
